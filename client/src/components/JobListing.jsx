...
const JobListing = () => {
  ...
  const [showFilter,setShowFilter] = useState(true) //made for mobile screen size
            ...
            <ul className='space-y-4 text-gray-600'>
              {JobCategories.map((category,index) => (
                <li className='flex gap-3 items-center' key={index}>
                    <input onChange={() => handleCategoryChange(category)} className='scale-125' type="checkbox" name='' id=''
           ...
           <div className={showFilter ? "" : "max-lg:hidden"}>
            ...
            <ul className='space-y-4 text-gray-600'>
              {JobLocations.map((location,index) => (
                <li className='flex gap-3 items-center' key={index}>
                    <input onChange={() => handleLocationChange(location)} className='scale-125' type="checkbox" name='' id=''
  ...
  <section className='w-full lg:w-3/4 text-gray-800 max-lg:px-4'>
    ...
    <div className='grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-4'>
      ...
      {/* Login for getting 6 jobs on first page  */}
